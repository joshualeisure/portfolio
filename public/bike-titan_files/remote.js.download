(function(g){var window=this;'use strict';var gYa=function(a,b,c){null!=c&&(g.ud(a,b,1),a=a.i,b=c>>>0,c=Math.floor((c-b)/4294967296)>>>0,g.xe=b,g.we=c,g.sd(a,g.xe),g.sd(a,g.we))},hYa=function(a,b,c){b=g.Kd(b,c);
null!=b&&(g.ud(a,c,0),a.i.i.push(b?1:0))},iYa=function(a,b){return g.pf(a,b)},jYa=function(a,b){b=b instanceof g.qg?b:g.wg(b,/^data:image\//i.test(b));
a.src=g.rg(b)},lYa=function(a){g.C.call(this,a,-1,kYa)},mYa=function(a){g.C.call(this,a)},pYa=function(){return[1,
nYa,2,oYa]},qYa=function(){return[1,
g.es,mYa,pYa]},rYa=function(a){g.C.call(this,a)},sYa=function(a){g.C.call(this,a)},uYa=function(){return[1,
g.gs,2,g.gs,3,tYa]},vYa=function(a){g.C.call(this,a)},xYa=function(){return[1,
g.gs,2,g.gs,3,wYa,4,tYa]},zYa=function(){return[1,
g.Ke,sYa,uYa,yYa,2,g.Ke,vYa,xYa,yYa]},DYa=function(){return[1,
AYa,g.Pi,2,BYa,g.Pi,3,CYa,g.Pi]},GYa=function(){return[1,
EYa,g.Oi,2,FYa,g.Oi,3,g.Ke,lYa,qYa,g.Oi]},IYa=function(){return[1,
g.es,g.Li,DYa,2,HYa,g.Mi,GYa]},MYa=function(){return[1,
g.gs,5,JYa,2,HYa,rYa,zYa,3,KYa,6,LYa,4,g.es,g.Ki,IYa]},W6=function(a){g.Fl(a,"zx",Math.floor(2147483648*Math.random()).toString(36)+Math.abs(Math.floor(2147483648*Math.random())^g.Ua()).toString(36));
return a},X6=function(a,b,c){Array.isArray(c)||(c=[String(c)]);
g.dm(a.u,b,c)},NYa=function(a){if(a===g.np)throw Error("ES6 Iteration protocol does NOT adjust control flow when StopIteration is thrown from callback helper functions. If your code relies on this behavior, consider throwing a different error and catching it to terminate iteration.");
throw a;},OYa=function(a){if(a instanceof g.lp)return a;
...
return c}throw Error("Not implemented");},PYa=function(a,b,c){if(g.Oa(a))try{g.wc(a,b,c)}catch(e){NYa(e)}else for(a=OYa(a);;){var d=void 0;
try{d=a.Oj()}catch(e){if(e===g.np)break;throw e;}try{b.call(c,d,void 0,a)}catch(e){NYa(e)}}},QYa=function(a,b){var c=[];
PYa(b,function(d){try{var e=g.Or.prototype.u.call(this,d,!0)}catch(f){if("Storage: Invalid value was encountered"==f)return;throw f;}void 0===e?c.push(d):g.kha(e)&&c.push(d)},a);
return c},RYa=function(a,b){QYa(a,b).forEach(function(c){g.Or.prototype.remove.call(this,c)},a)},SYa=function(a){if(a.ma){if(a.ma.locationOverrideToken)return{locationOverrideToken:a.ma.locationOverrideToken};
if(null!=a.ma.latitudeE7&&null!=a.ma.longitudeE7)return{latitudeE7:a.ma.latitudeE7,longitudeE7:a.ma.longitudeE7}}return null},TYa=function(a,b){g.cc(a,b)||a.push(b)},Y6=function(a){var b=0,c;
for(c in a)b++;return b},UYa=function(a){try{return g.B.JSON.parse(a)}catch(b){}a=String(a);
if(/^\s*$/.test(a)?0:/^[\],:{}\s\u2028\u2029]*$/.test(a.replace(/\\["\\\/bfnrtu]/g,"@").replace(/(?:"[^"\\\n\r\u2028\u2029\x00-\x08\x0a-\x1f]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?)[\s\u2028\u2029]*(?=:|,|]|}|$)/g,"]").replace(/(?:^|:|,)(?:[\s\u2028\u2029]*\[)+/g,"")))try{return eval("("+a+")")}catch(b){}throw Error("Invalid JSON string: "+a);},Z6=function(a){if(g.B.JSON)try{return g.B.JSON.parse(a)}catch(b){}return UYa(a)},VYa=function(a,b,c,d){var e=new g.xl(null,void 0);
...
a.user||"",this.avatar=a.userAvatarUri||"",this.obfuscatedGaiaId=a.obfuscatedGaiaId||"",this.theme=a.theme||"u",WYa(this,a.capabilities||""),XYa(this,a.experiments||""),this.brand=a.brand||"",this.model=a.model||"",this.year=a.year||0,this.os=a.os||"",this.osVersion=a.osVersion||"",this.chipset=a.chipset||"",this.mdxDialServerType=a.mdxDialServerType||"MDX_DIAL_SERVER_TYPE_UNKNOWN",a=a.deviceInfo)&&(a=JSON.parse(a),this.brand=a.brand||"",this.model=a.model||"",this.year=a.year||0,this.os=a.os||"",
this.osVersion=a.osVersion||"",this.chipset=a.chipset||"",this.clientName=a.clientName?a.clientName.toUpperCase():"UNKNOWN_INTERFACE",this.mdxDialServerType=a.mdxDialServerType||"MDX_DIAL_SERVER_TYPE_UNKNOWN")},WYa=function(a,b){a.capabilities.clear();
g.Hp(b.split(","),g.Ta(iYa,YYa)).forEach(function(c){a.capabilities.add(c)})},XYa=function(a,b){a.experiments.clear();
b.split(",").forEach(function(c){a.experiments.add(c)})},b7=function(a){a=a||{};
this.name=a.name||"";this.id=a.id||a.screenId||"";this.token=a.token||a.loungeToken||"";this.uuid=a.uuid||a.dialId||"";this.idType=a.screenIdType||"normal"},c7=function(a,b){return!!b&&(a.id==b||a.uuid==b)},ZYa=function(a){return{name:a.name,
screenId:a.id,loungeToken:a.token,dialId:a.uuid,screenIdType:a.idType}},$Ya=function(a){return new b7(a)},aZa=function(a){return Array.isArray(a)?g.Sn(a,$Ya):[]},d7=function(a){return a?'{name:"'+a.name+'",id:'+a.id.substr(0,6)+"..,token:"+((a.token?".."+a.token.slice(-6):"-")+",uuid:"+(a.uuid?".."+a.uuid.slice(-6):"-")+",idType:"+a.idType+"}"):"null"},e7=function(a){return Array.isArray(a)?"["+g.Sn(a,d7).join(",")+"]":"null"},f7=function(){return"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,
function(a){var b=16*Math.random()|0;
return("x"==a?b:b&3|8).toString(16)})},bZa=function(a){return g.Sn(a,function(b){return{key:b.id,
name:b.name}})},g7=function(a,b){return g.$b(a,function(c){return c||b?!c!=!b?!1:c.id==b.id:!0})},h7=function(a,b){return g.$b(a,function(c){return c7(c,b)})},cZa=function(){var a=(0,g.gy)();
a&&RYa(a,a.i.Og(!0))},i7=function(){var a=g.jy("yt-remote-connected-devices")||[];
g.sc(a);return a},dZa=function(a){if(g.dc(a))return[];
var b=a[0].indexOf("#"),c=-1==b?a[0]:a[0].substring(0,b);return g.Sn(a,function(d,e){return 0==e?d:d.substring(c.length)})},eZa=function(a){g.iy("yt-remote-connected-devices",a,86400)},k7=function(){if(j7)return j7;
...
g.cc(a,b);g.ly()&&g.vc(a,b);a=dZa(a);if(g.dc(a))try{g.Lka("remote_sid")}catch(c){}else try{g.Vt("remote_sid",a.join(","),-1)}catch(c){}},fZa=function(){return g.jy("yt-remote-session-browser-channel")},gZa=function(){return g.jy("yt-remote-local-screens")||[]},hZa=function(){g.iy("yt-remote-lounge-token-expiration",!0,86400)},iZa=function(a){5<a.length&&(a=a.slice(a.length-5));
var b=g.Sn(gZa(),function(d){return d.loungeToken}),c=g.Sn(a,function(d){return d.loungeToken});
g.Tn(c,function(d){return!g.cc(b,d)})&&hZa();
g.iy("yt-remote-local-screens",a,31536E3)},jZa=function(a,b){g.iy("yt-remote-session-browser-channel",a);
g.iy("yt-remote-session-screen-id",b);a=i7();b=k7();g.cc(a,b)||a.push(b);eZa(a);l7()},m7=function(a){a||(g.ky("yt-remote-session-screen-id"),g.ky("yt-remote-session-video-id"));
l7();a=i7();g.hc(a,k7());eZa(a)},kZa=function(){if(!n7){var a=g.Xr();
a&&(n7=new g.Lr(a))}},lZa=function(){kZa();
return n7?!!n7.get("yt-remote-use-staging-server"):!1},o7=function(){var a=window.navigator.userAgent.match(/Chrome\/([0-9]+)/);
return a?parseInt(a[1],10):0},mZa=function(a){return!!document.currentScript&&(-1!=document.currentScript.src.indexOf("?"+a)||-1!=document.currentScript.src.indexOf("&"+a))},nZa=function(){return"function"==typeof window.__onGCastApiAvailable?window.__onGCastApiAvailable:null},p7=function(a){a.length?oZa(a.shift(),function(){p7(a)}):q7()},pZa=function(a){return"chrome-extension://"+a+"/cast_sender.js"},oZa=function(a,b,c){var d=document.createElement("script");
d.onerror=b;c&&(d.onload=c);g.Rk(d,g.Br(a));(document.head||document.documentElement).appendChild(d)},qZa=function(){var a=o7(),b=[];
if(1<a){var c=a-1;b.push("//www.gstatic.com/eureka/clank/"+a+"/cast_sender.js");b.push("//www.gstatic.com/eureka/clank/"+c+"/cast_sender.js")}return b},q7=function(){var a=nZa();
a&&a(!1,"No cast extension found")},r7=function(){if(rZa){var a=2,b=nZa(),c=function(){a--;
0==a&&b&&b(!0)};
window.__onGCastApiAvailable=c;oZa("//www.gstatic.com/cast/sdk/libs/sender/1.0/cast_framework.js",q7,c)}},sZa=function(){r7();
var a=qZa();a.push("//www.gstatic.com/eureka/clank/cast_sender.js");p7(a)},uZa=function(){r7();
var a=qZa();a.push.apply(a,g.ma(tZa.map(pZa)));a.push("//www.gstatic.com/eureka/clank/cast_sender.js");p7(a)},vZa=function(){this.i=s7();
this.i.Ly("/client_streamz/youtube/living_room/mdx/browser_channel/closed_channels")},wZa=function(){this.i=s7();
this.i.Ly("/client_streamz/youtube/living_room/mdx/browser_channel/pending_maps")},xZa=function(){this.i=s7();
...
return g.B.setTimeout(function(){a()},b)},z7=function(a){y7.dispatchEvent(new yZa(y7,a))},yZa=function(a,b){g.Te.call(this,"statevent",a);
this.stat=b},A7=function(a,b,c,d){this.i=a;
this.B=b;this.S=c;this.K=d||1;this.u=45E3;this.C=new g.em(this);this.J=new g.Bi;this.J.setInterval(250)},AZa=function(a,b,c){a.ju=1;
a.xn=W6(b.clone());a.Jq=c;a.D=!0;zZa(a,null)},B7=function(a,b,c,d,e){a.ju=1;
a.xn=W6(b.clone());a.Jq=null;a.D=c;e&&(a.KO=!1);zZa(a,d)},zZa=function(a,b){a.Ot=Date.now();
C7(a);a.To=a.xn.clone();X6(a.To,"t",a.K);a.aC=0;a.Qf=a.i.fE(a.i.Nx()?b:null);0<a.UC&&(a.mB=new u7((0,g.Sa)(a.KP,a,a.Qf),a.UC));a.C.Ra(a.Qf,"readystatechange",a.MR);b=a.qp?g.wf(a.qp):{};a.Jq?(a.XB="POST",b["Content-Type"]="application/x-www-form-urlencoded",a.Qf.send(a.To,a.XB,a.Jq,b)):(a.XB="GET",a.KO&&!g.Xe&&(b.Connection="close"),a.Qf.send(a.To,a.XB,null,b));a.i.Pj(1)},CZa=function(a,b){var c=a.aC,d=b.indexOf("\n",c);
if(-1==d)return D7;c=Number(b.substring(c,d));if(isNaN(c))return BZa;d+=1;if(d+c>b.length)return D7;b=b.substr(d,c);a.aC=d+c;return b},EZa=function(a,b){a.Ot=Date.now();
C7(a);var c=b?window.location.hostname:"";a.To=a.xn.clone();g.Fl(a.To,"DOMAIN",c);g.Fl(a.To,"t",a.K);try{a.fk=new ActiveXObject("htmlfile")}catch(m){E7(a);a.hn=7;z7(22);F7(a);return}var d="<html><body>";if(b){var e="";for(b=0;b<c.length;b++){var f=c.charAt(b);if("<"==f)f=e+"\\x3c";else if(">"==f)f=e+"\\x3e";else{if(f in G7)f=G7[f];else if(f in DZa)f=G7[f]=DZa[f];else{var h=f.charCodeAt(0);if(31<h&&127>h)var l=f;else{if(256>h){if(l="\\x",16>h||256<h)l+="0"}else l="\\u",4096>h&&(l+="0");l+=h.toString(16).toUpperCase()}f=
...
a.u;
FZa(a,a.u)},FZa=function(a,b){if(null!=a.Cu)throw Error("WatchDog timer not null");
...
g.Qe(a.mB);a.mB=null;a.J.stop();g.gm(a.C);if(a.Qf){var b=a.Qf;a.Qf=null;b.abort();b.dispose()}a.fk&&(a.fk=null)},I7=function(a,b){try{a.i.LN(a,b),a.i.Pj(4)}catch(c){}},HZa=function(a,b,c,d,e){if(0==d)c(!1);
else{var f=e||0;d--;GZa(a,b,function(h){h?c(!0):g.B.setTimeout(function(){HZa(a,b,c,d,f)},f)})}},GZa=function(a,b,c){var d=new Image;
...
jYa(d,a)},J7=function(a){a.onload=null;
a.onerror=null;a.onabort=null;a.ontimeout=null},IZa=function(a){this.i=a;
this.u=new w7},JZa=function(a){var b=K7(a.i,a.uv,"/mail/images/cleardot.gif");
W6(b);HZa(b.toString(),5E3,(0,g.Sa)(a.pS,a),3,2E3);a.Pj(1)},M7=function(a){var b=a.i.X;
if(null!=b)z7(5),b?(z7(11),L7(a.i,a,!1)):(z7(12),L7(a.i,a,!0));else if(a.wh=new A7(a,void 0,void 0,void 0),a.wh.qp=a.wC,b=a.i,b=K7(b,b.Nx()?a.Ju:null,a.xC),z7(5),!g.Mc||g.Fc(10))X6(b,"TYPE","xmlhttp"),B7(a.wh,b,!1,a.Ju,!1);else{X6(b,"TYPE","html");var c=a.wh;a=!!a.Ju;c.ju=3;c.xn=W6(b.clone());EZa(c,a)}},N7=function(a,b,c){this.i=1;
this.u=[];this.C=[];this.D=new w7;this.S=a||null;this.X=null!=b?b:null;this.J=c||!1},KZa=function(a,b){this.i=a;
this.map=b;this.context=null},LZa=function(a,b,c,d){g.Te.call(this,"timingevent",a);
this.size=b;this.Dx=d},MZa=function(a){g.Te.call(this,"serverreachability",a)},PZa=function(a){NZa(a);
if(3==a.i){var b=a.Qw++,c=a.wz.clone();g.Fl(c,"SID",a.B);g.Fl(c,"RID",b);g.Fl(c,"TYPE","terminate");O7(a,c);b=new A7(a,a.B,b,void 0);b.ju=2;b.xn=W6(c.clone());jYa(new Image,b.xn.toString());b.Ot=Date.now();C7(b)}OZa(a)},QZa=function(a){a.US(1,0);
a.wz=K7(a,null,a.yC);P7(a)},NZa=function(a){a.Bn&&(a.Bn.abort(),a.Bn=null);
a.Re&&(a.Re.cancel(),a.Re=null);a.Rl&&(g.B.clearTimeout(a.Rl),a.Rl=null);Q7(a);a.Zg&&(a.Zg.cancel(),a.Zg=null);a.Ln&&(g.B.clearTimeout(a.Ln),a.Ln=null)},RZa=function(a,b){if(0==a.i)throw Error("Invalid operation: sending map when state is closed");
a.u.push(new KZa(a.GU++,b));2!=a.i&&3!=a.i||P7(a)},SZa=function(a){var b=0;
a.Re&&b++;a.Zg&&b++;return b},P7=function(a){a.Zg||a.Ln||(a.Ln=x7((0,g.Sa)(a.QN,a),0),a.Js=0)},UZa=function(a,b){if(1==a.i){if(!b){a.Qw=Math.floor(1E5*Math.random());
b=a.Qw++;var c=new A7(a,"",b,void 0);c.qp=a.vk;var d=R7(a),e=a.wz.clone();g.Fl(e,"RID",b);g.Fl(e,"CVER","1");O7(a,e);AZa(c,e,d);a.Zg=c;a.i=2}}else 3==a.i&&(b?TZa(a,b):0==a.u.length||a.Zg||TZa(a))},TZa=function(a,b){if(b)if(6<a.Jp){a.u=a.C.concat(a.u);
a.C.length=0;var c=a.Qw-1;b=R7(a)}else c=b.S,b=b.Jq;else c=a.Qw++,b=R7(a);var d=a.wz.clone();g.Fl(d,"SID",a.B);g.Fl(d,"RID",c);g.Fl(d,"AID",a.ot);O7(a,d);c=new A7(a,a.B,c,a.Js+1);c.qp=a.vk;c.setTimeout(1E4+Math.round(1E4*Math.random()));a.Zg=c;AZa(c,d,b)},O7=function(a,b){a.Rf&&(a=a.Rf.kL())&&g.cf(a,function(c,d){g.Fl(b,d,c)})},R7=function(a){var b=Math.min(a.u.length,1E3),c=["count="+b];
...
return c.join("&")},VZa=function(a){a.Re||a.Rl||(a.K=1,a.Rl=x7((0,g.Sa)(a.PN,a),0),a.ls=0)},S7=function(a){if(a.Re||a.Rl||3<=a.ls)return!1;
a.K++;a.Rl=x7((0,g.Sa)(a.PN,a),WZa(a,a.ls));a.ls++;return!0},L7=function(a,b,c){a.VB=c;
a.wk=b.El;a.J||QZa(a)},Q7=function(a){null!=a.Rp&&(g.B.clearTimeout(a.Rp),a.Rp=null)},WZa=function(a,b){var c=5E3+Math.floor(1E4*Math.random());
a.isActive()||(c*=2);return c*b},T7=function(a,b){if(2==b||9==b){var c=null;
a.Rf&&(c=null);var d=(0,g.Sa)(a.QY,a);c||(c=new g.xl("//www.google.com/images/cleardot.gif"),W6(c));GZa(c.toString(),1E4,d)}else z7(2);XZa(a,b)},XZa=function(a,b){a.i=0;
a.Rf&&a.Rf.yK(b);OZa(a);NZa(a)},OZa=function(a){a.i=0;
...
if(""!=d.i)b&&g.zl(d,b+"."+d.i),g.Al(d,d.B);else{var e=window.location;d=VYa(e.protocol,b?b+"."+e.hostname:e.hostname,+e.port,c)}a.Pv&&g.cf(a.Pv,function(f,h){g.Fl(d,h,f)});
g.Fl(d,"VER",a.Jp);O7(a,d);return d},YZa=function(){},ZZa=function(){this.i=[];
this.u=[]},$Za=function(){},s7=function(){if(!U7){U7=new g.Ei(new $Za);
var a=g.kt("client_streamz_web_flush_count",-1);-1!==a&&(U7.C=a)}return U7},a_a=function(a,b){this.action=a;
...
e=void 0===e?!1:e;this.ya=a;this.J=b;this.B=new g.Kr;this.u=new V7(this.rY,this);this.i=null;this.Z=!1;this.D=null;this.X="";this.S=this.C=0;this.K=[];this.Ba=c;this.ma=d;this.Ja=e;this.Aa=new vZa;this.Ka=new wZa;this.Na=new xZa},b_a=function(a){return{firstTestResults:[""],
secondTestResults:!a.i.VB,sessionId:a.i.B,arrayId:a.i.ot}},c_a=function(a,b){a.S=b||0;
a.u.stop();X7(a);a.i&&(3==a.i.getState()&&UZa(a.i),PZa(a.i));a.S=0},Y7=function(a){return!!a.i&&3==a.i.getState()},X7=function(a){if(a.i){var b=a.ma(),c=a.i.vk||{};
...
method:"POST",context:a,timeout:5E3,withCredentials:!1,onSuccess:g.Ta(a.C,d,!0),onError:g.Ta(a.B,e),onTimeout:g.Ta(a.D,e)};c&&(a.postParams=c,a.headers={"Content-Type":"application/x-www-form-urlencoded"});return g.Mt(b,a)},g_a=function(){var a=d_a;
e_a();b8.push(a);f_a()},c8=function(a,b){e_a();
var c=h_a(a,String(b));g.dc(b8)?i_a(c):(f_a(),g.wc(b8,function(d){d(c)}))},e_a=function(){b8||(b8=g.Ka("yt.mdx.remote.debug.handlers_")||[],g.Ja("yt.mdx.remote.debug.handlers_",b8,void 0))},i_a=function(a){var b=(d8+1)%50;
d8=b;e8[b]=a;f8||(f8=49==b)},f_a=function(){var a=b8;
if(e8[0]){var b=f8?d8:-1;do{b=(b+1)%50;var c=e8[b];g.wc(a,function(d){d(c)})}while(b!=d8);
e8=Array(50);d8=-1;f8=!1}},h_a=function(a,b){var c=(Date.now()-j_a)/1E3;
c.toFixed&&(c=c.toFixed(3));var d=[];d.push("[",c+"s","] ");d.push("[","yt.mdx.remote","] ");d.push(a+": "+b,"\n");return d.join("")},g8=function(a){g.tx.call(this);
this.J=a;this.screens=[]},k_a=function(a,b){var c=a.get(b.uuid)||a.get(b.id);
if(c)return a=c.name,c.id=b.id||c.id,c.name=b.name,c.token=b.token,c.uuid=b.uuid||c.uuid,c.name!=a;a.screens.push(b);return!0},l_a=function(a,b){var c=a.screens.length!=b.length;
a.screens=g.Hp(a.screens,function(f){return!!g7(b,f)});
for(var d=0,e=b.length;d<e;d++)c=k_a(a,b[d])||c;return c},m_a=function(a,b){var c=a.screens.length;
...
this.u=a;this.i=NaN;i8(this);this.info("Initializing with "+e7(this.screens))},n_a=function(a){if(a.screens.length){var b=g.Sn(a.screens,function(d){return d.id}),c=$7(a.u,"/pairing/get_lounge_token_batch");
a8(a.u,c,{screen_ids:b.join(",")},(0,g.Sa)(a.uT,a),(0,g.Sa)(a.tT,a))}},i8=function(a){if(g.P("deprecate_pair_servlet_enabled"))return l_a(a,[]);
var b=aZa(gZa());b=g.Hp(b,function(c){return!c.uuid});
return l_a(a,b)},k8=function(a,b){iZa(g.Sn(a.screens,ZYa));
b&&hZa()},m8=function(a,b){g.tx.call(this);
...
else{c=g.nf(b);for(var d=0,e=c.length;d<e;++d)if(!a.i[c[d]]){c=!1;break a}c=!0}c||(l8("Updated online screens: "+g.lj(a.i)),a.i=b,a.ea("screenChange"));o_a(a)},p8=function(a){isNaN(a.B)||g.It(a.B);
a.B=g.Gt((0,g.Sa)(a.SG,a),0<a.C&&a.C<g.Ua()?2E4:1E4)},l8=function(a){c8("OnlineScreenService",a)},p_a=function(a){var b={};
g.wc(a.J(),function(c){c.token?b[c.token]=c.id:this.ye("Requesting availability of screen w/o lounge token.")});
return b},o_a=function(a){a=g.nf(g.df(a.i,function(b){return b}));
...
g8.call(this,"ScreenService");this.C=a;this.K=b;this.i=this.u=null;this.B=[];this.D={};q_a(this)},s_a=function(a,b,c,d,e,f){a.info("getAutomaticScreenByIds "+c+" / "+b);
c||(c=a.D[b]);var h=a.Kh(),l=c?h7(h,c):null;c&&(a.K||l)||(l=h7(h,b));if(l){l.uuid=b;var m=r8(a,l);n8(a.i,m,function(n){e(n?m:null)})}else c?r_a(a,c,(0,g.Sa)(function(n){var p=r8(this,new b7({name:d,
screenId:c,loungeToken:n,dialId:b||""}));n8(this.i,p,function(r){e(r?p:null)})},a),f):e(null)},t_a=function(a,b){for(var c=0,d=a.screens.length;c<d;++c)if(a.screens[c].name==b)return a.screens[c];
return null},u_a=function(a,b,c){n8(a.i,b,c)},r_a=function(a,b,c,d){a.info("requestLoungeToken_ for "+b);
...
g.Mt($7(a.C,"/pairing/get_lounge_token_batch"),e)},v_a=function(a){a.screens=a.u.Kh();
var b=a.D,c={},d;for(d in b)c[b[d]]=d;b=0;for(d=a.screens.length;b<d;++b){var e=a.screens[b];e.uuid=c[e.id]||""}a.info("Updated manual screens: "+e7(a.screens))},q_a=function(a){s8(a);
a.u=new j8(a.C);a.u.subscribe("screenChange",(0,g.Sa)(a.DT,a));v_a(a);a.K||(a.B=aZa(g.jy("yt-remote-automatic-screen-cache")||[]));s8(a);a.info("Initializing automatic screens: "+e7(a.B));a.i=new m8(a.C,(0,g.Sa)(a.Kh,a,!0));a.i.subscribe("screenChange",(0,g.Sa)(function(){this.ea("onlineScreenChange")},a))},r8=function(a,b){var c=a.get(b.id);
c?(c.uuid=b.uuid,b=c):((c=h7(a.B,b.uuid))?(c.id=b.id,c.token=b.token,b=c):a.B.push(b),a.K||w_a(a));s8(a);a.D[b.uuid]=b.id;g.iy("yt-remote-device-id-map",a.D,31536E3);return b},w_a=function(a){a=g.Hp(a.B,function(b){return"shortLived"!=b.idType});
g.iy("yt-remote-automatic-screen-cache",g.Sn(a,ZYa))},s8=function(a){a.D=g.jy("yt-remote-device-id-map")||{}},t8=function(a,b,c){g.tx.call(this);
this.Ba=c;this.B=a;this.i=b;this.C=null},u8=function(a,b){a.C=b;
a.ea("sessionScreen",a.C)},x_a=function(a,b){a.C&&(a.C.token=b,r8(a.B,a.C));
a.ea("sessionScreen",a.C)},v8=function(a,b){c8(a.Ba,b)},w8=function(a,b,c){t8.call(this,a,b,"CastSession");
var d=this;this.config_=c;this.u=null;this.ma=(0,g.Sa)(this.lQ,this);this.Aa=(0,g.Sa)(this.PX,this);this.Z=g.Gt(function(){y_a(d,null)},12E4);
this.K=this.D=this.J=this.S=0;this.ya=!1;this.X="unknown"},x8=function(a,b){g.It(a.K);
a.K=0;0==b?z_a(a):a.K=g.Gt(function(){z_a(a)},b)},z_a=function(a){A_a(a,"getLoungeToken");
g.It(a.D);a.D=g.Gt(function(){B_a(a,null)},3E4)},A_a=function(a,b){a.info("sendYoutubeMessage_: "+b+" "+g.lj(void 0));
var c={};c.type=b;a.u?a.u.sendMessage("urn:x-cast:com.google.youtube.mdx",c,g.La,(0,g.Sa)(function(){v8(this,"Failed to send message: "+b+".")},a)):v8(a,"Sending yt message without session: "+g.lj(c))},y8=function(a,b){b?(a.info("onConnectedScreenId_: Received screenId: "+b),a.getScreen()&&a.getScreen().id==b||a.xL(b,function(c){u8(a,c)},function(){return a.Cg()},5)):a.Cg(Error("Waiting for session status timed out."))},D_a=function(a,b,c){a.info("onConnectedScreenData_: Received screenData: "+JSON.stringify(b));
var d=new b7(b);C_a(a,d,function(e){e?(a.ya=!0,r8(a.B,d),u8(a,d),a.X="unknown",x8(a,c)):(g.ot(Error("CastSession, RemoteScreen from screenData: "+JSON.stringify(b)+" is not online.")),a.Cg())},5)},y_a=function(a,b){g.It(a.Z);
a.Z=0;b?a.config_.enableCastLoungeToken&&b.loungeToken?b.deviceId?a.getScreen()&&a.getScreen().uuid==b.deviceId||(b.loungeTokenRefreshIntervalMs?D_a(a,{name:a.i.friendlyName,screenId:b.screenId,loungeToken:b.loungeToken,dialId:b.deviceId,screenIdType:"shortLived"},b.loungeTokenRefreshIntervalMs):(g.ot(Error("No loungeTokenRefreshIntervalMs presents in mdxSessionStatusData: "+JSON.stringify(b)+".")),y8(a,b.screenId))):(g.ot(Error("No device id presents in mdxSessionStatusData: "+JSON.stringify(b)+
".")),y8(a,b.screenId)):y8(a,b.screenId):a.Cg(Error("Waiting for session status timed out."))},B_a=function(a,b){g.It(a.D);
a.D=0;var c=null;if(b)if(b.loungeToken){var d;(null==(d=a.getScreen())?void 0:d.token)==b.loungeToken&&(c="staleLoungeToken")}else c="missingLoungeToken";else c="noLoungeTokenResponse";c?(a.info("Did not receive a new lounge token in onLoungeToken_ with data: "+(JSON.stringify(b)+", error: "+c)),a.X=c,x8(a,3E4)):(x_a(a,b.loungeToken),a.ya=!1,a.X="unknown",x8(a,b.loungeTokenRefreshIntervalMs))},C_a=function(a,b,c,d){g.It(a.J);
a.J=0;u_a(a.B,b,function(e){e||0>d?c(e):a.J=g.Gt(function(){C_a(a,b,c,d-1)},300)})},E_a=function(a){g.It(a.S);
...
return!!(a.config_.enableDialLoungeToken&&(null==(b=a.u)?0:b.getDialAppInfo))},F_a=function(a){a.D=a.B.yI(a.Aa,a.i.label,a.i.friendlyName,A8(a),function(b,c){a.D=g.La;
a.ma=!0;u8(a,b);"shortLived"==b.idType&&0<c&&B8(a,c)},function(b){a.D=g.La;
a.Cg(b)})},G_a=function(a){var b={};
b.pairingCode=a.Aa;b.theme=a.Na;lZa()&&(b.env_useStageMdx=1);return g.Ej(b)},C8=function(a){return new Promise(function(b){a.Aa=f7();
if(a.Ka){var c=new chrome.cast.DialLaunchResponse(!0,G_a(a));b(c);F_a(a)}else a.Z=function(){g.It(a.X);a.Z=function(){};
a.X=NaN;var d=new chrome.cast.DialLaunchResponse(!0,G_a(a));b(d);F_a(a)},a.X=g.Gt(function(){a.Z()},100)})},I_a=function(a,b,c){a.info("initOnConnectedScreenDataPromise_: Received screenData: "+JSON.stringify(b));
var d=new b7(b);return(new Promise(function(e){H_a(a,d,function(f){f?(a.ma=!0,r8(a.B,d),u8(a,d),B8(a,c)):g.ot(Error("DialSession, RemoteScreen from screenData: "+JSON.stringify(b)+" is not online."));e(f)},5)})).then(function(e){return e?new chrome.cast.DialLaunchResponse(!1):C8(a)})},J_a=function(a,b){var c=a.S.receiver.label,d=a.i.friendlyName;
return(new Promise(function(e){s_a(a.B,c,b,d,function(f){f&&f.token&&u8(a,f);e(f)},function(f){v8(a,"Failed to get DIAL screen: "+f);
e(null)})})).then(function(e){return e&&e.token?new chrome.cast.DialLaunchResponse(!1):C8(a)})},H_a=function(a,b,c,d){g.It(a.J);
a.J=0;u_a(a.B,b,function(e){e||0>d?c(e):a.J=g.Gt(function(){H_a(a,b,c,d-1)},300)})},B8=function(a,b){a.info("getDialAppInfoWithTimeout_ "+b);
A8(a)&&(g.It(a.K),a.K=0,0==b?K_a(a):a.K=g.Gt(function(){K_a(a)},b))},K_a=function(a){A8(a)&&a.u.getDialAppInfo(function(b){a.info("getDialAppInfo dialLaunchData: "+JSON.stringify(b));
b=b.extraData||{};var c=null;if(b.loungeToken){var d;(null==(d=a.getScreen())?void 0:d.token)==b.loungeToken&&(c="staleLoungeToken")}else c="missingLoungeToken";c?(a.ya=c,B8(a,3E4)):(a.ma=!1,a.ya="unknown",x_a(a,b.loungeToken),B8(a,b.loungeTokenRefreshIntervalMs))},function(b){a.info("getDialAppInfo error: "+b);
a.ya="noLoungeTokenResponse";B8(a,3E4)})},L_a=function(a){g.It(a.J);
...
this.config_=b;this.u=a;this.S=b.appId||"233637DE";this.C=b.theme||"cl";this.X=b.disableCastApi||!1;this.J=b.forceMirroring||!1;this.i=null;this.K=!1;this.B=[];this.D=(0,g.Sa)(this.IW,this)},M_a=function(a,b){return b?g.$b(a.B,function(c){return c7(b,c.label)},a):null},F8=function(a){c8("Controller",a)},d_a=function(a){window.chrome&&chrome.cast&&chrome.cast.logMessage&&chrome.cast.logMessage(a)},G8=function(a){return a.K||!!a.B.length||!!a.i},H8=function(a,b,c){b!=a.i&&(g.Qe(a.i),(a.i=b)?(c?a.ea("yt-remote-cast2-receiver-resumed",
b.i):a.ea("yt-remote-cast2-receiver-selected",b.i),b.subscribe("sessionScreen",(0,g.Sa)(a.ON,a,b)),b.subscribe("sessionFailed",function(){return N_a(a,b)}),b.getScreen()?a.ea("yt-remote-cast2-session-change",b.getScreen()):c&&a.i.qt(null)):a.ea("yt-remote-cast2-session-change",null))},N_a=function(a,b){a.i==b&&a.ea("yt-remote-cast2-session-failed")},O_a=function(a){var b=a.u.xI(),c=a.i&&a.i.i;
a=g.Sn(b,function(d){c&&c7(d,c.label)&&(c=null);var e=d.uuid?d.uuid:d.id,f=M_a(this,d);f?(f.label=e,f.friendlyName=d.name):(f=new chrome.cast.Receiver(e,d.name),f.receiverType=chrome.cast.ReceiverType.CUSTOM);return f},a);
c&&(c.receiverType!=chrome.cast.ReceiverType.CUSTOM&&(c=new chrome.cast.Receiver(c.label,c.friendlyName),c.receiverType=chrome.cast.ReceiverType.CUSTOM),a.push(c));return a},T_a=function(a,b,c,d){d.disableCastApi?I8("Cannot initialize because disabled by Mdx config."):P_a()?Q_a(b,d)&&(J8(!0),window.chrome&&chrome.cast&&chrome.cast.isAvailable?R_a(a,c):(window.__onGCastApiAvailable=function(e,f){e?R_a(a,c):(K8("Failed to load cast API: "+f),L8(!1),J8(!1),g.ky("yt-remote-cast-available"),g.ky("yt-remote-cast-receiver"),
S_a(),c(!1))},d.loadCastApiSetupScript?g.my("https://www.gstatic.com/cv/js/sender/v1/cast_sender.js"):0<=window.navigator.userAgent.indexOf("Android")&&0<=window.navigator.userAgent.indexOf("Chrome/")&&window.navigator.presentation?60<=o7()&&sZa():!window.chrome||!window.navigator.presentation||0<=window.navigator.userAgent.indexOf("Edge")?q7():89<=o7()?uZa():(r7(),p7(tZa.map(pZa))))):I8("Cannot initialize because not running Chrome")},S_a=function(){I8("dispose");
var a=M8();a&&a.dispose();g.Ja("yt.mdx.remote.cloudview.instance_",null,void 0);U_a(!1);g.Uu(N8);N8.length=0},O8=function(){return!!g.jy("yt-remote-cast-installed")},V_a=function(){var a=g.jy("yt-remote-cast-receiver");
return a?a.friendlyName:null},W_a=function(){I8("clearCurrentReceiver");
g.ky("yt-remote-cast-receiver")},X_a=function(){return O8()?M8()?M8().getCastSession():(K8("getCastSelector: Cast is not initialized."),null):(K8("getCastSelector: Cast API is not installed!"),null)},Q8=function(){O8()?M8()?P8()?(I8("Requesting cast selector."),M8().requestSession()):(I8("Wait for cast API to be ready to request the session."),N8.push(g.Tu("yt-remote-cast2-api-ready",Q8))):K8("requestCastSelector: Cast is not initialized."):K8("requestCastSelector: Cast API is not installed!")},R8=
function(a,b){P8()?M8().setConnectedScreenStatus(a,b):K8("setConnectedScreenStatus called before ready.")},P_a=function(){var a=0<=g.Ab().search(/ (CrMo|Chrome|CriOS)\//);
return g.Tz||a},Y_a=function(a,b){M8().init(a,b)},Q_a=function(a,b){var c=!1;
...
I8("cloudview.createSingleton_: "+c);return c},M8=function(){return g.Ka("yt.mdx.remote.cloudview.instance_")},R_a=function(a,b){L8(!0);
J8(!1);Y_a(a,function(c){c?(U_a(!0),g.Vu("yt-remote-cast2-api-ready")):(K8("Failed to initialize cast API."),L8(!1),g.ky("yt-remote-cast-available"),g.ky("yt-remote-cast-receiver"),S_a());b(c)})},I8=function(a){c8("cloudview",a)},K8=function(a){c8("cloudview",a)},L8=function(a){I8("setCastInstalled_ "+a);
g.iy("yt-remote-cast-installed",a)},P8=function(){return!!g.Ka("yt.mdx.remote.cloudview.apiReady_")},U_a=function(a){I8("setApiReady_ "+a);
...
this.B=0;this.C=a;this.J=[];this.D=new ZZa;this.u=this.i=null;this.X=(0,g.Sa)(this.pV,this);this.K=(0,g.Sa)(this.Zw,this);this.S=(0,g.Sa)(this.oV,this);this.Z=(0,g.Sa)(this.wV,this);var c=0;a?(c=a.getProxyState(),3!=c&&(a.subscribe("proxyStateChange",this.kH,this),Z_a(this))):c=3;0!=c&&(b?this.kH(c):g.Gt((0,g.Sa)(function(){this.kH(c)},this),0));
(a=X_a())&&Z8(this,a);this.subscribe("yt-remote-cast2-session-change",this.Z)},a9=function(a){return new S8(a.C.getPlayerContextData())},Z_a=function(a){g.wc("nowAutoplaying autoplayDismissed remotePlayerChange remoteQueueChange autoplayModeChange autoplayUpNext previousNextChange multiStateLoopEnabled loopModeChange".split(" "),function(b){this.J.push(this.C.subscribe(b,g.Ta(this.GW,b),this))},a)},$_a=function(a){g.wc(a.J,function(b){this.C.unsubscribeByKey(b)},a);
...
V8(d,c);-1E3!=d.playerState&&(d.playerState=b);d9(a,d)},f9=function(a,b,c){a.C.sendMessage(b,c)},d9=function(a,b){$_a(a);
a.C.setPlayerContextData(Y8(b));Z_a(a)},Z8=function(a,b){a.u&&(a.u.removeUpdateListener(a.X),a.u.removeMediaListener(a.K),a.Zw(null));
a.u=b;a.u&&(c8("CP","Setting cast session: "+a.u.sessionId),a.u.addUpdateListener(a.X),a.u.addMediaListener(a.K),a.u.media.length&&a.Zw(a.u.media[0]))},a0a=function(a){var b=a.i.media,c=a.i.customData;
...
this.u=[];this.yc=new S8;this.Ka=b.id;this.Aa=b.idType;this.i=b0a(this,c);this.i.subscribe("handlerOpened",this.tV,this);this.i.subscribe("handlerClosed",this.qV,this);this.i.subscribe("handlerError",this.rV,this);this.i.subscribe("handlerMessage",this.sV,this);this.i.yB(b.token);this.subscribe("remoteQueueChange",function(){var f=this.yc.videoId;g.ly()&&g.iy("yt-remote-session-video-id",f)},this)},c0a=function(a){return g.$b(a.u,function(b){return"LOUNGE_SCREEN"==b.type})},i9=function(a){c8("conn",
a)},b0a=function(a,b){return new W7($7(a.Ja,"/bc"),b,!1,function(){return a.CI()},"shortLived"==a.Aa)},j9=function(a,b){a.ea("proxyStateChange",b)},d0a=function(a){a.D=g.Gt(function(){i9("Connecting timeout");
a.Fs(1)},2E4)},k9=function(a){g.It(a.D);
a.D=NaN},l9=function(a){g.It(a.ma);
a.ma=NaN},e0a=function(a){m9(a);
a.Z=g.Gt(function(){n9(a,"getNowPlaying")},2E4)},m9=function(a){g.It(a.Z);
a.Z=NaN},g0a=function(a,b){var c=null;
if(b){var d=c0a(a);d&&(c={clientName:d.clientName,deviceMake:d.brand,deviceModel:d.model,osVersion:d.osVersion})}g.Ja("yt.mdx.remote.remoteClient_",c,void 0);b&&(k9(a),l9(a));c=Y7(a.i)&&isNaN(a.D);b==c?b&&(j9(a,1),n9(a,"getSubtitlesTrack")):b?(a.wL()&&a.yc.reset(),j9(a,1),n9(a,"getNowPlaying"),f0a(a)):a.Fs(1)},h0a=function(a,b){var c=b.params.videoId;
delete b.params.videoId;c==a.yc.videoId&&(g.sf(b.params)?a.yc.trackData=null:a.yc.trackData=b.params,a.ea("remotePlayerChange"))},i0a=function(a,b,c){var d=b.params.videoId||b.params.video_id,e=parseInt(b.params.currentIndex,10);
a.yc.listId=b.params.listId||a.yc.listId;X8(a.yc,d,e);a.ea("remoteQueueChange",c)},k0a=function(a,b){b.params=b.params||{};
i0a(a,b,"NOW_PLAYING_MAY_CHANGE");j0a(a,b);a.ea("autoplayDismissed")},j0a=function(a,b){var c=parseInt(b.params.currentTime||b.params.current_time,10);
V8(a.yc,isNaN(c)?0:c);c=parseInt(b.params.state,10);c=isNaN(c)?-1:c;-1==c&&-1E3==a.yc.playerState&&(c=-1E3);a.yc.playerState=c;c=Number(b.params.loadedTime);a.yc.S=isNaN(c)?0:c;a.yc.Yj(Number(b.params.duration));c=a.yc;var d=Number(b.params.liveIngestionTime);c.B=d;c.u=isNaN(d)?!1:!0;c=a.yc;d=Number(b.params.seekableStartTime);b=Number(b.params.seekableEndTime);c.C=isNaN(d)?0:d;c.i=isNaN(b)?0:b;1==a.yc.playerState?e0a(a):m9(a);a.ea("remotePlayerChange")},l0a=function(a,b){if(-1E3!=a.yc.playerState){var c=
1085;
switch(parseInt(b.params.adState,10)){case 1:c=1081;break;case 2:c=1084;break;case 0:c=1083}a.yc.playerState=c;b=parseInt(b.params.currentTime,10);V8(a.yc,isNaN(b)?0:b);a.ea("remotePlayerChange")}},m0a=function(a,b){var c="true"==b.params.muted;
a.yc.volume=parseInt(b.params.volume,10);a.yc.muted=c;a.ea("remotePlayerChange")},n0a=function(a,b){a.J=b.params.videoId;
a.ea("nowAutoplaying",parseInt(b.params.timeout,10))},o0a=function(a,b){var c="true"==b.params.hasNext;
a.yc.Wk="true"==b.params.hasPrevious;a.yc.hasNext=c;a.ea("previousNextChange")},f0a=function(a){g.It(a.S);
...
this.Ye=a;this.i=[];this.i.push(this.Ye.$_s("screenChange",(0,g.Sa)(this.qQ,this)));this.i.push(this.Ye.$_s("onlineScreenChange",(0,g.Sa)(this.mW,this)))},s0a=function(a,b){kZa();
if(!n7||!n7.get("yt-remote-disable-remote-module-for-dev")){b=g.O("MDX_CONFIG")||b;cZa();l7();p9||(p9=new Z7(b?b.loungeApiHost:void 0),lZa()&&(p9.i="/api/loungedev"));q9||(q9=g.Ka("yt.mdx.remote.deferredProxies_")||[],g.Ja("yt.mdx.remote.deferredProxies_",q9,void 0));p0a();var c=r9();if(!c){var d=new q8(p9,b?b.disableAutomaticScreenCache||!1:!1);g.Ja("yt.mdx.remote.screenService_",d,void 0);c=r9();var e={};b&&(e={appId:b.appId,disableDial:b.disableDial,theme:b.theme,loadCastApiSetupScript:b.loadCastApiSetupScript,
disableCastApi:b.disableCastApi,enableDialLoungeToken:b.enableDialLoungeToken,enableCastLoungeToken:b.enableCastLoungeToken,forceMirroring:b.forceMirroring});g.Ja("yt.mdx.remote.enableConnectWithInitialState_",b?b.enableConnectWithInitialState||!1:!1,void 0);T_a(a,d,function(f){f?s9()&&R8(s9(),"YouTube TV"):d.subscribe("onlineScreenChange",function(){$6("yt-remote-receiver-availability-change")})},e)}b&&!g.Ka("yt.mdx.remote.initialized_")&&(g.Ja("yt.mdx.remote.initialized_",!0,void 0),t9("Initializing: "+
...
$6("yt-remote-auto-connect","cast-selector-receiver")})),u9.push(g.Tu("yt-remote-cast2-receiver-resumed",function(){$6("yt-remote-receiver-resumed","cast-selector-receiver")})),u9.push(g.Tu("yt-remote-cast2-session-change",q0a)),u9.push(g.Tu("yt-remote-connection-change",function(f){f?R8(s9(),"YouTube TV"):w9()||(R8(null,null),W_a())})),u9.push(g.Tu("yt-remote-cast2-session-failed",function(){$6("yt-remote-connection-failed")})),a=x9(),b.isAuto&&(a.id+="#dial"),e=b.capabilities||[],g.P("desktop_enable_autoplay")&&
e.push("atp"),0<e.length&&(a.capabilities=e),a.name=b.device,a.app=b.app,(b=b.theme)&&(a.theme=b),t9(" -- with channel params: "+g.lj(a)),a?(g.iy("yt-remote-session-app",a.app),g.iy("yt-remote-session-name",a.name)):(g.ky("yt-remote-session-app"),g.ky("yt-remote-session-name")),g.Ja("yt.mdx.remote.channelParams_",a,void 0),c.start(),s9()||r0a())}},t0a=function(){var a=r9().Ye.$_gos();
var b=y9();b&&z9()&&(g7(a,b)||a.push(b));return bZa(a)},A9=function(){var a=u0a();
!a&&O8()&&V_a()&&(a={key:"cast-selector-receiver",name:V_a()});return a},u0a=function(){var a=t0a(),b=y9();
b||(b=w9());return g.$b(a,function(c){return b&&c7(b,c.key)?!0:!1})},y9=function(){var a=s9();
if(!a)return null;var b=r9().Kh();return h7(b,a)},q0a=function(a){t9("remote.onCastSessionChange_: "+d7(a));
...
G9=a?new o9(a):null}return G9},s9=function(){return g.Ka("yt.mdx.remote.currentScreenId_")},v0a=function(a){g.Ja("yt.mdx.remote.currentScreenId_",a,void 0)},w0a=function(){return g.Ka("yt.mdx.remote.connectData_")},v9=function(a){g.Ja("yt.mdx.remote.connectData_",a,void 0)},z9=function(){return g.Ka("yt.mdx.remote.connection_")},E9=function(a){var b=z9();
v9(null);a||v0a("");g.Ja("yt.mdx.remote.connection_",a,void 0);q9&&(g.wc(q9,function(c){c(a)}),q9.length=0);
...
y9()&&y9();if(H9)B9=a;else{v0a(a.id);var c=g.Ka("yt.mdx.remote.enableConnectWithInitialState_")||!1;a=new h9(p9,a,x9(),c);a.connect(b,w0a());a.subscribe("beforeDisconnect",function(d){$6("yt-remote-before-disconnect",d)});
...
E9(a)}},r0a=function(){var a=w9();
a?(t9("Resume connection to: "+d7(a)),D9(a,0)):(m7(),W_a(),t9("Skipping connecting because no session screen found."))},p0a=function(){var a=x9();
...
var d=this;this.u=a;this.I=b;this.Xb=c;this.events=new g.qC(this);this.Z=this.events.T(this.I,"onVolumeChange",function(e){x0a(d,e)});
...
a=this.Xb;a.isDisposed();a.subscribe("proxyStateChange",this.KN,this);a.subscribe("remotePlayerChange",this.gx,this);a.subscribe("remoteQueueChange",this.RA,this);a.subscribe("previousNextChange",this.HN,this);a.subscribe("nowAutoplaying",this.BN,this);a.subscribe("autoplayDismissed",this.eN,this);g.H(this,this.i);g.H(this,this.B);g.H(this,this.S);g.H(this,this.X);g.H(this,this.K);this.cP();this.RA();this.gx()},x0a=function(a,b){if(J9(a)){a.Xb.unsubscribe("remotePlayerChange",a.gx,a);
var c=Math.round(b.volume);b=!!b.muted;var d=a9(a.Xb);if(c!==d.volume||b!==d.muted)a.Xb.setVolume(c,b),a.X.start();a.Xb.subscribe("remotePlayerChange",a.gx,a)}},y0a=function(a){a.Sb(0);
...
if(null===c||void 0===c?0:c.listId){var d=c.index;var e=c.listId.toString()}c=a.I.getVideoData(1);a.Xb.playVideo(c.videoId,b,d,e,c.playerParams,c.bb,SYa(c));a.Yb(new g.OI(1))},z0a=function(a,b){if(b){var c=a.I.getOption("captions","tracklist",{UL:1});
...
"ytp-mdx-privacy-popup-confirm"],va:"Confirm"}]}]}]});this.i=new g.LK(this,250);this.cancelButton=this.Fa("ytp-mdx-privacy-popup-cancel");this.confirmButton=this.Fa("ytp-mdx-privacy-popup-confirm");g.H(this,this.i);this.T(this.cancelButton,"click",this.u);this.T(this.confirmButton,"click",this.B)},N9=function(a){g.V.call(this,{G:"div",
L:"ytp-remote",V:[{G:"div",L:"ytp-remote-display-status",V:[{G:"div",L:"ytp-remote-display-status-icon",V:[g.aK()]},{G:"div",L:"ytp-remote-display-status-text",va:"{{statustext}}"}]}]});this.api=a;this.i=new g.LK(this,250);g.H(this,this.i);this.T(a,"presentingplayerstatechange",this.onStateChange);A0a(this,a.Bb())},A0a=function(a,b){if(3===a.api.getPresentingPlayerType()){var c={RECEIVER_NAME:a.api.getOption("remote","currentReceiver").name};
b=g.U(b,128)?g.iH("Error on $RECEIVER_NAME",c):b.Jc()||g.U(b,4)?g.iH("Playing on $RECEIVER_NAME",c):g.iH("Connected to $RECEIVER_NAME",c);a.Pa("statustext",b);a.i.show()}else a.i.hide()},O9=function(a,b){g.sP.call(this,"Play on",0,a,b);
...
this.fl={key:f7(),name:"This computer"};this.ji=null;this.subscriptions=[];this.EG=this.Xb=null;this.Qo=[this.fl];this.Dn=this.fl;this.Id=new g.OI(64);this.sM=0;this.Df=-1;this.ox=!1;this.mx=this.Jt=null;if(!g.bE(this.player.U())&&!g.cE(this.player.U())){a=this.player;var b=g.VL(a);b&&(b=b.Vn())&&(b=new O9(a,b),g.H(this,b));b=new N9(a);g.H(this,b);g.eM(a,b.element,4);this.Jt=new M9;g.H(this,this.Jt);g.eM(a,this.Jt.element,4);this.ox=!!w9()}},Q9=function(a){a.mx&&(a.player.removeEventListener("presentingplayerstatechange",
a.mx),a.mx=null)},B0a=function(a,b,c){a.Id=c;
a.player.ea("presentingplayerstatechange",new g.RG(c,b))},R9=function(a,b){if(b.key!==a.Dn.key)if(b.key===a.fl.key)C9();
else{var c;(c=!a.player.U().N("mdx_enable_privacy_disclosure_ui"))||(c=((c=g.O("PLAYER_CONFIG"))&&c.args&&void 0!==c.args.authuser?!0:!(!g.O("SESSION_INDEX")&&!g.O("LOGGED_IN")))||a.ox||!a.Jt);(c?0:g.rE(a.player.U())||g.uE(a.player.U()))&&C0a(a);a.Dn=b;if(!a.player.U().N("disable_mdx_connection_in_mdx_module_for_music_web")||!g.cE(a.player.U())){var d=a.player.getPlaylistId();c=a.player.getVideoData(1);var e=c.videoId;if(!d&&!e||(2===a.player.getAppState()||1===a.player.getAppState())&&a.player.U().N("should_clear_video_data_on_player_cued_unstarted"))a=
null;else{var f=a.player.getPlaylist();if(f){var h=[];for(var l=0;l<f.length;l++)h[l]=g.mM(f,l).videoId}else h=[e];f=a.player.getCurrentTime(1);a={videoIds:h,listId:d,videoId:e,playerParams:c.playerParams,clickTrackingParams:c.bb,index:Math.max(a.player.getPlaylistIndex(),0),currentTime:0===f?void 0:f};(c=SYa(c))&&(a.locationInfo=c)}t9("Connecting to: "+g.lj(b));"cast-selector-receiver"==b.key?(v9(a||null),b=a||null,P8()?M8().setLaunchParams(b):K8("setLaunchParams called before ready.")):!a&&F9()&&
s9()==b.key?$6("yt-remote-connection-change",!0):(C9(),v9(a||null),a=r9().Kh(),(b=h7(a,b.key))&&D9(b,1))}}},C0a=function(a){a.player.Bb().Jc()?a.player.pauseVideo():(a.mx=function(b){!a.ox&&g.TG(b,8)&&(a.player.pauseVideo(),Q9(a))},a.player.addEventListener("presentingplayerstatechange",a.mx));
a.Jt&&a.Jt.kd();z9()||(H9=!0)};
g.Xc.prototype.D=g.ca(0,function(){var a=g.ad(this);return 4294967296*g.ad(this)+(a>>>0)});
var nYa=g.ve(function(a,b,c){if(1!==a.u)return!1;g.D(b,c,g.kd(a));return!0},g.ye),FYa=g.ve(function(a,b,c,d){if(1!==a.u)return!1;
g.Qd(b,c,d,g.kd(a));return!0},g.ye),oYa=g.ve(function(a,b,c){if(0!==a.u)return!1;
g.D(b,c,g.Yc(a.i));return!0},g.ze),EYa=g.ve(function(a,b,c,d){if(0!==a.u)return!1;
g.Qd(b,c,d,g.Yc(a.i));return!0},g.ze),wYa=g.ve(function(a,b,c){if(0!==a.u)return!1;
g.D(b,c,g.$c(a.i));return!0},g.Ae),BYa=g.ve(function(a,b,c,d){if(0!==a.u)return!1;
g.Qd(b,c,d,g.$c(a.i));return!0},g.Ae),JYa=g.ve(function(a,b,c){if(1!==a.u)return!1;
g.D(b,c,a.i.D());return!0},function(a,b,c){gYa(a,c,g.Kd(b,c))}),LYa=g.ve(function(a,b,c){if(1!==a.u&&2!==a.u)return!1;
...
if(null!=b)for(var d=0;d<b.length;d++)gYa(a,c,b[d])}),tYa=g.ve(function(a,b,c){if(0!==a.u)return!1;
g.D(b,c,!!g.$c(a.i));return!0},hYa),CYa=g.ve(function(a,b,c,d){if(0!==a.u)return!1;
g.Qd(b,c,d,!!g.$c(a.i));return!0},hYa),KYa=g.ve(function(a,b,c){if(2!==a.u)return!1;
a=g.md(a);g.Ld(b,c).push(a);return!0},function(a,b,c){b=g.Ld(b,c);
if(null!=b)for(var d=0;d<b.length;d++){var e=b[d];null!=e&&g.xd(a,c,g.ib(e))}}),AYa=g.ve(function(a,b,c,d){if(2!==a.u)return!1;
g.Qd(b,c,d,g.md(a));return!0},g.Be),HYa=g.ve(function(a,b,c,d,e){if(2!==a.u)return!1;
g.jd(a,g.Rd(b,d,c),e);return!0},g.Ce),kYa=[1];
g.u(lYa,g.C);g.u(mYa,g.C);g.u(rYa,g.C);g.u(sYa,g.C);var yYa=[1,2];g.u(vYa,g.C);var DZa={"\x00":"\\0","\b":"\\b","\f":"\\f","\n":"\\n","\r":"\\r","\t":"\\t","\v":"\\x0B",'"':'\\"',"\\":"\\\\","<":"\\u003C"},G7={"'":"\\'"},YYa={F_:"atp",Wba:"ska",Baa:"que",p9:"mus",Vba:"sus",b5:"dsp",Zaa:"seq",S8:"mic",X3:"dpa",T_:"cds",n9:"mlm",U3:"dsdtr",V9:"ntb"};a7.prototype.equals=function(a){return a?this.id==a.id:!1};
var n7,j7="",rZa=mZa("loadCastFramework")||mZa("loadCastApplicationFramework"),tZa=["pkedcjkdefgpdelpbcmbmeomcjbeemfm","enhhojjnijigcajfphajepfemndkmdlo"];/*
...
g.k.KX=function(){this.Cu=null;var a=Date.now();0<=a-this.dI?(2!=this.ju&&this.i.Pj(3),E7(this),this.hn=2,z7(18),F7(this)):FZa(this,this.dI-a)};
g.k.getLastError=function(){return this.hn};g.k=IZa.prototype;g.k.wC=null;g.k.wh=null;g.k.nB=!1;g.k.YO=null;g.k.vz=null;g.k.zF=null;g.k.xC=null;g.k.Zh=null;g.k.El=-1;g.k.Ju=null;g.k.uv=null;g.k.connect=function(a){this.xC=a;a=K7(this.i,null,this.xC);z7(3);this.YO=Date.now();var b=this.i.S;null!=b?(this.Ju=b[0],(this.uv=b[1])?(this.Zh=1,JZa(this)):(this.Zh=2,M7(this))):(X6(a,"MODE","init"),this.wh=new A7(this,void 0,void 0,void 0),this.wh.qp=this.wC,B7(this.wh,a,!1,null,!0),this.Zh=0)};
...
a&&Q7(this),!g.nb(b))for(a=this.D.parse(b),b=0;b<a.length;b++)c=a[b],this.ot=c[0],c=c[1],2==this.i?"c"==c[0]?(this.B=c[1],this.uy=c[2],c=c[3],null!=c?this.Jp=c:this.Jp=6,this.i=3,this.Rf&&this.Rf.AK(),this.iK=K7(this,this.Nx()?this.uy:null,this.yC),VZa(this)):"stop"==c[0]&&T7(this,7):3==this.i&&("stop"==c[0]?T7(this,7):"noop"!=c[0]&&this.Rf&&this.Rf.zK(c),this.ls=0)};
g.k.jV=function(){null!=this.Rp&&(this.Rp=null,this.Re.cancel(),this.Re=null,S7(this),z7(20))};
g.k.sy=function(a){if(this.Re==a){Q7(this);this.Re=null;var b=2}else if(this.Zg==a)this.Zg=null,b=1;else return;this.wk=a.Xu;if(0!=this.i)if(a.Vm)if(1==b){b=Date.now()-a.Ot;var c=y7;c.dispatchEvent(new LZa(c,a.Jq?a.Jq.length:0,b,this.Js));P7(this);this.C.length=0}else VZa(this);else{c=a.getLastError();var d;if(!(d=3==c||7==c||0==c&&0<this.wk)){if(d=1==b)this.Zg||this.Ln||1==this.i||2<=this.Js?d=!1:(this.Ln=x7((0,g.Sa)(this.QN,this,a),WZa(this,this.Js)),this.Js++,d=!0);d=!(d||2==b&&S7(this))}if(d)switch(c){case 1:T7(this,
...
g.k.QY=function(a){a?z7(2):(z7(1),XZa(this,8))};
...
g.k.Pj=function(a){var b=y7;b.dispatchEvent(new MZa(b,a))};
g.k.Nx=function(){return!(!g.Mc||g.Fc(10))};
g.k=YZa.prototype;g.k.AK=function(){};
g.k.zK=function(){};
g.k.yK=function(){};
g.k.QD=function(){};
g.k.kL=function(){return{}};
g.k.isActive=function(){return!0};g.k=ZZa.prototype;g.k.isEmpty=function(){return 0===this.i.length&&0===this.u.length};
...
g.k.Bi=function(){for(var a=[],b=this.i.length-1;0<=b;--b)a.push(this.i[b]);var c=this.u.length;for(b=0;b<c;++b)a.push(this.u[b]);return a};$Za.prototype.flush=function(a,b){a=void 0===a?[]:a;b=void 0===b?!1:b;if(g.P("enable_client_streamz_web")){a=g.q(a);for(var c=a.next();!c.done;c=a.next())c=g.Qi(c.value),c={serializedIncrementBatch:g.Ic(g.ue(c,MYa))},g.Fv("streamzIncremented",c,{eH:b})}};var U7;g.Va(V7,g.E);g.k=V7.prototype;g.k.uX=function(){this.ag=Math.min(3E5,2*this.ag);this.B();this.u&&this.start()};
g.k.start=function(){var a=this.ag+15E3*Math.random();g.ar(this.i,a);this.u=Date.now()+a};
g.k.stop=function(){this.i.stop();this.u=0};
g.k.isActive=function(){return this.i.isActive()};
g.k.reset=function(){this.i.stop();this.ag=5E3};g.Va(W7,YZa);g.k=W7.prototype;g.k.subscribe=function(a,b,c){return this.B.subscribe(a,b,c)};
...
g.k.dispose=function(){this.Z||(this.Z=!0,g.Qe(this.B),c_a(this),g.Qe(this.u),this.u=null,this.ma=function(){return""})};
g.k.isDisposed=function(){return this.Z};
g.k.connect=function(a,b,c){if(!this.i||2!=this.i.getState()){this.X="";this.u.stop();this.D=a||null;this.C=b||0;a=this.ya+"/test";b=this.ya+"/bind";var d=new N7(c?c.firstTestResults:null,c?c.secondTestResults:null,this.Ba),e=this.i;e&&(e.Rf=null);d.Rf=this;this.i=d;X7(this);if(this.i){d=g.O("ID_TOKEN");var f=this.i.vk||{};d?f["x-youtube-identity-token"]=d:delete f["x-youtube-identity-token"];this.i.vk=f}e?(3!=e.getState()&&0==SZa(e)||e.getState(),this.i.connect(a,b,this.J,e.B,e.ot)):c?this.i.connect(a,
b,this.J,c.sessionId,c.arrayId):this.i.connect(a,b,this.J)}};
g.k.sendMessage=function(a,b){a={_sc:a};b&&g.zf(a,b);this.u.isActive()||2==(this.i?this.i.getState():0)?this.K.push(a):Y7(this)&&(X7(this),RZa(this.i,a))};
g.k.AK=function(){this.u.reset();this.D=null;this.C=0;if(this.K.length){var a=this.K;this.K=[];for(var b=0,c=a.length;b<c;++b)RZa(this.i,a[b])}this.ea("handlerOpened")};
...
g.k.zK=function(a){"S"==a[0]?this.X=a[1]:"gracefulReconnect"==a[0]?(this.u.start(),PZa(this.i)):this.ea("handlerMessage",new a_a(a[0],a[1]))};
...
g.k.rY=function(){this.u.isActive();0==SZa(this.i)&&this.connect(this.D,this.C)};Z7.prototype.C=function(a,b,c,d){b?a(d):a({text:c.responseText})};
Z7.prototype.B=function(a,b){a(Error("Request error: "+b.status))};
Z7.prototype.D=function(a){a(Error("request timed out"))};var j_a=Date.now(),b8=null,e8=Array(50),d8=-1,f8=!1;g.Va(g8,g.tx);g8.prototype.Kh=function(){return this.screens};
...
g.k.hQ=function(a){this.i=null;a.status&&404==a.status?this.u>=D0a.length?this.ea("pairingFailed",Error("DIAL polling timed out")):(a=D0a[this.u],this.Pb=g.Gt((0,g.Sa)(this.dO,this),a),this.u++):this.ea("pairingFailed",Error("Server error "+a.status))};
g.k.jQ=function(){this.i=null;this.ea("pairingFailed",Error("Server not responding"))};
var D0a=[2E3,2E3,1E3,1E3,1E3,2E3,2E3,5E3,5E3,1E4];g.Va(j8,g8);g.k=j8.prototype;g.k.start=function(){i8(this)&&this.ea("screenChange");!g.jy("yt-remote-lounge-token-expiration")&&n_a(this);g.It(this.i);this.i=g.Gt((0,g.Sa)(this.start,this),1E4)};
g.k.add=function(a,b){i8(this);k_a(this,a);k8(this,!1);this.ea("screenChange");b(a);a.token||n_a(this)};
g.k.remove=function(a,b){var c=i8(this);m_a(this,a)&&(k8(this,!1),c=!0);b(a);c&&this.ea("screenChange")};
...
g.k.SG=function(){g.It(this.B);this.B=NaN;this.u&&this.u.abort();var a=p_a(this);if(Y6(a)){var b=$7(this.D,"/pairing/get_screen_availability");this.u=a8(this.D,b,{lounge_token:g.nf(a).join(",")},(0,g.Sa)(this.aX,this,a),(0,g.Sa)(this.ZW,this))}else o8(this,{}),p8(this)};
g.k.aX=function(a,b){this.u=null;var c=g.nf(p_a(this));if(g.uc(c,g.nf(a))){b=b.screens||[];c={};for(var d=0,e=b.length;d<e;++d)c[a[b[d].loungeToken]]="online"==b[d].status;o8(this,c);p8(this)}else this.ye("Changing Screen set during request."),this.SG()};
...
g.k.kQ=function(a,b,c,d){g.Mt($7(this.C,"/pairing/get_screen"),{method:"POST",postParams:{pairing_code:a},timeout:5E3,onSuccess:(0,g.Sa)(function(e,f){e=new b7(f.screen||{});if(!e.name||t_a(this,e.name)){a:{f=e.name;for(var h=2,l=b(f,h);t_a(this,l);){h++;if(20<h)break a;l=b(f,h)}f=l}e.name=f}c(r8(this,e))},this),
...
g.k.DT=function(){v_a(this);this.ea("screenChange");this.i.update()};
...
g.k.jH=function(){};
g.k.xa=function(){this.info("disposeInternal");E_a(this);this.u&&(this.u.removeUpdateListener(this.ma),this.u.removeMessageListener("urn:x-cast:com.google.youtube.mdx",this.Aa));this.u=null;t8.prototype.xa.call(this)};
g.k.PX=function(a,b){if(!this.isDisposed())if(b)if(b=Z6(b),g.Pa(b))switch(a=""+b.type,b=b.data||{},this.info("onYoutubeMessage_: "+a+" "+g.lj(b)),a){case "mdxSessionStatus":y_a(this,b);break;case "loungeToken":B_a(this,b);break;default:v8(this,"Unknown youtube message: "+a)}else v8(this,"Unable to parse message.");else v8(this,"No data in message.")};
g.k.xL=function(a,b,c,d){g.It(this.S);this.S=0;s_a(this.B,this.i.label,a,this.i.friendlyName,(0,g.Sa)(function(e){e?b(e):0<=d?(v8(this,"Screen "+a+" appears to be offline. "+d+" retries left."),this.S=g.Gt((0,g.Sa)(this.xL,this,a,b,c,d-1),300)):c(Error("Unable to fetch screen."))},this),c)};
...
g.k.stop=function(){L_a(this);this.u?this.u.stop((0,g.Sa)(this.Cg,this,null),(0,g.Sa)(this.Cg,this,"Failed to stop DIAL device.")):this.Cg()};
g.k.xa=function(){L_a(this);this.u&&this.u.removeUpdateListener(this.Ja);this.u=null;t8.prototype.xa.call(this)};
...
g.k.xa=function(){this.u.unsubscribe("onlineScreenChange",(0,g.Sa)(this.AI,this));window.chrome&&chrome.cast&&chrome.cast.removeReceiverActionListener(this.D);var a=d_a,b=g.Ka("yt.mdx.remote.debug.handlers_");g.hc(b||[],a);g.Qe(this.i);g.tx.prototype.xa.call(this)};
...
this.ea("yt-remote-cast2-session-change",this.i.getScreen()),Promise.resolve(new chrome.cast.DialLaunchResponse(!1));this.ye('Changing CAST intent from "'+c.receiverType+'" to "dial" for '+b.friendlyName);H8(this,new z8(this.u,b,this.C,this.config_))}b=this.i;b.S=a;b.S.appState==chrome.cast.DialAppState.RUNNING?(a=b.S.extraData||{},c=a.screenId||null,A8(b)&&a.loungeToken?a.loungeTokenRefreshIntervalMs?a=I_a(b,{name:b.i.friendlyName,screenId:a.screenId,loungeToken:a.loungeToken,dialId:b.S.receiver.label,
screenIdType:"shortLived"},a.loungeTokenRefreshIntervalMs):(g.ot(Error("No loungeTokenRefreshIntervalMs presents in additionalData: "+JSON.stringify(a)+".")),a=J_a(b,c)):a=J_a(b,c)):a=C8(b);return a};
...
g.k.AI=function(){this.isDisposed()||(this.B=O_a(this),F8("Updating custom receivers: "+g.lj(this.B)),chrome.cast.setCustomReceivers(this.B,g.La,(0,g.Sa)(function(){this.ye("Failed to set custom receivers.")},this)),this.ea("yt-remote-cast2-availability-change",G8(this)))};
...
g.k.xa=function(){$_a(this);this.C=null;this.D.clear();Z8(this,null);g.tx.prototype.xa.call(this)};
...
g.k.Zw=function(a){c8("CP","Cast media: "+!!a);this.i&&this.i.removeUpdateListener(this.S);if(this.i=a)this.i.addUpdateListener(this.S),a0a(this),this.ea("remotePlayerChange")};
g.k.oV=function(a){a?(a0a(this),this.ea("remotePlayerChange")):this.Zw(null)};
g.k.FH=function(){f9(this,"sendDebugCommand",{debugCommand:"stats4nerds "})};
g.k.wV=function(){var a=X_a();a&&Z8(this,a)};
...
n);this.C="UNSUPPORTED";c=this.Ba?"setInitialState":"setPlaylist";i9("Connecting with "+c+" and params: "+g.lj(m));this.i.connect({method:c,params:g.lj(m)},a,fZa())}else i9("Connecting without params"),this.i.connect({},a,fZa());d0a(this)};
...
g0a(this,a);a=this.dM("mlm");this.ea("multiStateLoopEnabled",a);break;case "loungeScreenDisconnected":g.ic(this.u,function(c){return"LOUNGE_SCREEN"==c.type});
g0a(this,!1);break;case "remoteConnected":var b=new a7(Z6(a.params.device));g.$b(this.u,function(c){return c.equals(b)})||TYa(this.u,b);
break;case "remoteDisconnected":b=new a7(Z6(a.params.device));g.ic(this.u,function(c){return c.equals(b)});
break;case "gracefulDisconnect":break;case "playlistModified":i0a(this,a,"QUEUE_MODIFIED");break;case "nowPlaying":k0a(this,a);break;case "onStateChange":j0a(this,a);break;case "onAdStateChange":l0a(this,a);break;case "onVolumeChanged":m0a(this,a);break;case "onSubtitlesTrackChanged":h0a(this,a);break;case "nowAutoplaying":n0a(this,a);break;case "autoplayDismissed":this.ea("autoplayDismissed");break;case "autoplayUpNext":this.J=a.params.videoId||null;this.ea("autoplayUpNext",this.J);break;case "onAutoplayModeChanged":this.C=
a.params.autoplayMode;this.ea("autoplayModeChange",this.C);"DISABLED"==this.C&&this.ea("autoplayDismissed");break;case "onHasPreviousNextChanged":o0a(this,a);break;case "requestAssistedSignIn":this.ea("assistedSignInRequested",a.params.authCode);break;case "onLoopModeChanged":this.ea("loopModeChange",a.params.loopMode);break;default:i9("Unrecognized action: "+a.action)}};
g.k.nT=function(){var a=3;this.isDisposed()||(a=0,isNaN(this.hw())?Y7(this.i)&&isNaN(this.D)&&(a=1):a=2);return a};
g.k.Fs=function(a){i9("Disconnecting with "+a);g.Ja("yt.mdx.remote.remoteClient_",null,void 0);k9(this);this.ea("beforeDisconnect",a);1==a&&m7();c_a(this.i,a);this.dispose()};
...
g.k.uY=function(a,b){n9(this,a,b);f0a(this)};
...
g.k.XV=function(){g.sf(this.C)||z0a(this,this.C);this.D=!1};
...
break;case -1:this.Yb(new g.OI(64));break;case -1E3:this.Yb(new g.OI(128,{errorCode:"mdx.remoteerror",errorMessage:"This video is not available for remote playback."}))}a=a9(this.Xb).trackData;var b=this.C;(a||b?a&&b&&a.trackName==b.trackName&&a.languageCode==b.languageCode&&a.languageName==b.languageName&&a.kind==b.kind:1)||(this.C=a,z0a(this,a));a=a9(this.Xb);-1===a.volume||Math.round(this.I.getVolume())===a.volume&&this.I.isMuted()===a.muted||this.X.isActive()||this.CP()}else y0a(this)};
g.k.HN=function(){this.I.ea("mdxpreviousnextchange")};
g.k.RA=function(){J9(this)||y0a(this)};
...
g.k.CP=function(){var a=this;if(J9(this)){var b=a9(this.Xb);this.events.xc(this.Z);b.muted?this.I.mute():this.I.unMute();this.I.setVolume(b.volume);this.Z=this.events.T(this.I,"onVolumeChange",function(c){x0a(a,c)})}};
...
g.k.Yb=function(a){this.B.stop();var b=this.J;if(!g.TI(b,a)){var c=g.U(a,2);c!==g.U(this.J,2)&&this.I.Ut(c);this.J=a;B0a(this.u,b,a)}};g.u(M9,g.V);M9.prototype.kd=function(){this.i.show()};
M9.prototype.Fb=function(){this.i.hide()};
M9.prototype.u=function(){$6("mdx-privacy-popup-cancel");this.Fb()};
M9.prototype.B=function(){$6("mdx-privacy-popup-confirm");this.Fb()};g.u(N9,g.V);N9.prototype.onStateChange=function(a){A0a(this,a.state)};g.u(O9,g.sP);O9.prototype.D=function(){var a=this.I.getOption("remote","receivers");a&&1<a.length&&!this.I.getOption("remote","quickCast")?(this.Qo=g.xc(a,this.i,this),g.tP(this,g.Sn(a,this.i)),a=this.I.getOption("remote","currentReceiver"),a=this.i(a),this.options[a]&&this.di(a),this.enable(!0)):this.enable(!1)};
O9.prototype.i=function(a){return a.key};
O9.prototype.xj=function(a){return"cast-selector-receiver"===a?"Cast...":this.Qo[a].name};
...
g.k.create=function(){var a=this.player.U(),b=g.$D(a);a={device:"Desktop",app:"youtube-desktop",loadCastApiSetupScript:a.N("mdx_load_cast_api_bootstrap_script"),enableDialLoungeToken:a.N("enable_dial_short_lived_lounge_token"),enableCastLoungeToken:a.N("enable_cast_short_lived_lounge_token")};s0a(b,a);this.subscriptions.push(g.Tu("yt-remote-before-disconnect",this.lV,this));this.subscriptions.push(g.Tu("yt-remote-connection-change",this.MW,this));this.subscriptions.push(g.Tu("yt-remote-receiver-availability-change",this.JN,
...
g.k.load=function(){this.player.cancelPlayback();g.sM.prototype.load.call(this);this.ji=new I9(this,this.player,this.Xb);var a=(a=w0a())?a.currentTime:0;var b=F9()?new $8(z9(),void 0):null;0==a&&b&&(a=W8(a9(b)));0!==a&&this.Sb(a);B0a(this,this.Id,this.Id);this.player.vl(6)};
...
g.k.JN=function(){var a=[this.fl],b=a.concat,c=t0a();O8()&&g.jy("yt-remote-cast-available")&&c.push({key:"cast-selector-receiver",name:"Cast..."});this.Qo=b.call(a,c);a=A9()||this.fl;R9(this,a);this.player.Qa("onMdxReceiversChange")};
